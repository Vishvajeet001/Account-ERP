...
app.get('/home', function _callee(req, res) {
...
app.get('/api/companies', function _callee2(req, res) {
  var companies;
...
app.get('/api/directors', function _callee3(req, res) {
  var directors;
...
app.get('/ofload', function _callee4(req, res) {
...
app.get('/cdreg', function _callee5(req, res) {
...
app.get('/qpage', function _callee6(req, res) {
...
app.post('/signup', function _callee7(req, res) {
...
app.post('/fgpass', function _callee9(req, res) {
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 4:
          ...
          return _context9.abrupt("return", res.status(400).send('User not found'));
...
app.post('/creg', upload.single('addressProof'), function _callee10(req, res) {
  var data, userdata;
...
app.post('/dreg', function _callee11(req, res) {
  var data, userdata;
...
app.post('/cdreg', function _callee14(req, res) {
  var data, userdata;
...
app.post('/qpage', function _callee15(req, res) {
  var data, userdata;
